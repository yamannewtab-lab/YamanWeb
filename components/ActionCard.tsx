...
const ActionCard: React.FC<ActionCardProps> = ({ title, description, buttonText, onButtonClick, buttonClassName, icon }) => {
    return (
        <div className="bg-gray-900/80 p-6 rounded-xl flex flex-col text-left transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-2xl border border-transparent hover:border-amber-500/30">
            <div className="bg-gray-800/60 p-3 rounded-lg self-start mb-4">
                {icon}
            </div>
