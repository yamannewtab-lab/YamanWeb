    ...
    return (
        <div>
            <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-stone-800 dark:text-stone-100">{t('teachersPageTitle')}</h2>
            </div>

            <div className="max-w-2xl mx-auto">
                <div className="bg-stone-50 dark:bg-stone-700 rounded-lg shadow-lg overflow-hidden">
                    <div className="md:flex">
                        <div className="md:flex-shrink-0">
                            {/* Canvas for picture */}
                            <div className="h-48 w-full object-cover md:w-48 bg-stone-200 dark:bg-stone-600 flex items-center justify-center">
                                <span className="text-stone-500 dark:text-stone-400 text-sm">Image coming soon</span>
                            </div>
                        </div>
                        <div className="p-8">
                            ...
                            <p className="mt-2 text-stone-500 dark:text-stone-400">{t('teacherYamanBio')}</p>
                        </div>
                    </div>
                </div>
            </div>
