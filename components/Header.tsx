        ...
        <header className="p-4 sm:p-6 border-b border-slate-200 dark:border-slate-700 flex items-center" dir="ltr">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
                ...
                >
                    ...
                    {/* Sun Icon */}
                    <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 absolute transition-all duration-500 ease-in-out ${isDarkMode ? 'opacity-0 -rotate-90' : 'opacity-100 rotate-0'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
