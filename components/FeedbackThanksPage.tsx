...
const FeedbackThanksPage: React.FC<FeedbackThanksPageProps> = ({ navigateTo, t }) => {
    return (
        <div className="text-center py-16">
            ...
            <h2 className="mt-6 text-3xl font-bold text-stone-800 dark:text-gray-100">{t('feedbackThanksMessage')}</h2>
            <p className="mt-2 text-stone-600 dark:text-gray-400">{t('feedbackThanksText')}</p>
