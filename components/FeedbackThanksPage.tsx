...
const FeedbackThanksPage: React.FC<FeedbackThanksPageProps> = ({ navigateTo, t }) => {
    return (
        <div className="text-center py-16">
            <div className="inline-block bg-pink-100 p-4 rounded-full dark:bg-pink-900/50">
            ...
            <h2 className="mt-6 text-3xl font-bold text-slate-800 dark:text-slate-100">{t('feedbackThanksMessage')}</h2>
            <p className="mt-2 text-slate-600 dark:text-slate-400">{t('feedbackThanksText')}</p>
