...
const ThanksPage: React.FC<ThanksPageProps> = ({ navigateTo, t }) => {
    return (
        <div className="text-center py-16">
            <div className="inline-block bg-green-100 dark:bg-green-900/50 p-4 rounded-full">
            ...
            <p className="mt-2 text-slate-600 dark:text-slate-300">{t('thanksText')}</p>
