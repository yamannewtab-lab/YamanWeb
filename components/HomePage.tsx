                ...
                <div className="relative z-10 px-4 py-8 sm:py-16">
                    ...
                    <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                        ...
                        <button 
                            ...
                            className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold text-lg rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 ease-in-out focus:outline-none focus:ring-4 focus:ring-green-800 animate-pulse-glow"
                        >
                            {t('heroJoinButton')}
                        </button>
                        <button 
