    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <CourseCard imgSrc="./imgs/tajwid_course.jpg" title={t('course3Text')} onImageClick={onImageClick} />
                <CourseCard imgSrc="./imgs/fiqh_course.jpg" title={t('course4Text')} onImageClick={onImageClick} />
            </div>
