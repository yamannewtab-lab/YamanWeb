    ...
    return (
        <div>
            <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-stone-800 dark:text-stone-100">{t('coursesTitle')}</h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-stone-50 rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow dark:bg-stone-700 flex flex-col">
                    ...
                    <div className="p-6 flex-grow">
                        <h3 className="font-bold text-xl text-stone-800 dark:text-stone-100">{t('course3Text')}</h3>
                    </div>
                </div>
                ...
                <div className="bg-stone-50 rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow dark:bg-stone-700 flex flex-col">
                    ...
                    <div className="p-6 flex-grow">
                        <h3 className="font-bold text-xl text-stone-800 dark:text-stone-100">{t('course4Text')}</h3>
                    </div>
                </div>
            </div>
