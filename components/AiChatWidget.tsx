        ...
        <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 pointer-events-none">
            ...
            >
                <div className="relative text-center p-4 border-b border-stone-200/80 dark:border-gray-700/60 flex-shrink-0">
                    <h2 className="text-xl font-bold text-stone-800 dark:text-gray-100">{t('askAiPageTitle')}</h2>
            ...
            <button
                ...
                className={`
                    absolute bottom-0 right-0 w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-600 
